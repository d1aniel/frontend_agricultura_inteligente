...
export const ADMIN_ENTITIES: AdminEntity[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'nombre_completo', label: 'Nombre completo', type: 'text', hideInForm: true },
      { key: 'username', label: 'Usuario', type: 'text', hideInCreate: true, required: true },
      { key: 'first_name', label: 'Nombres', type: 'text', hideInCreate: true },
      { key: 'last_name', label: 'Apellidos', type: 'text', hideInCreate: true },
      { key: 'email', label: 'Email', type: 'email', hideInCreate: true, required: true },
      { key: 'organizacion', label: 'Organizacion', type: 'select', relation: { entityKey: 'organizacion', labelFields: ['nombre', 'nit_documento'], createRoute: 'organizaciones' } },
      { key: 'telefono', label: 'Telefono', type: 'text' },
